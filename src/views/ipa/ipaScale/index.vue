...
<script>
  import { listPatient, getPatient, delPatient, addPatient, updatePatient, exportPatient } from "@/api/ipa/patient";
  import {listType,getType, delType,addType } from "@/api/patient/type";
  import {listTask, getTask,addTask,delTask,updateTask,exportTask,getTaskByPatientId,updateByPatientId,getWorkstation} from "@/api/ipa/task";
