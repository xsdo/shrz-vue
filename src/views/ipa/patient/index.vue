...
<script>
import { listPatient, getPatient, delPatient, addPatient, updatePatient, exportPatient,delAllTask } from "@/api/ipa/patient";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除心身调节系统患者编号为"' + patientIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有心身调节系统患者数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
