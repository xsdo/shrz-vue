...
<script>
  import { listPatient, getPatient, delPatient, addPatient, updatePatient, exportPatient } from "@/api/peri/patient";
  import {listType,getType, delType,addType } from "@/api/patient/type";
  import {listTask, getTask,addTask,delTask,updateTask,exportTask,getTaskByPatientId,updateByPatientId,getWorkstation} from "@/api/peri/task";
  ...
  export default {
    ...
    methods: {
      ...
      handleNode(data, checked) {
        let arr = [];
        if (checked) {
          this.checkedId = data.typeId;
          this.$refs.tree.setCheckedNodes([data])
          arr.push(data.typeName)
          this.tags = arr;
          this.form.typeids = data.typeId;
          this.form.typeNames = data.typeName;
        }else{
          if(this.checkedId == data.typeId){
            this.tags = [];
            this.form.typeids = '';
            this.form.typeNames = '';
          }
