...
<script>
  import { listTask, getTask, delTask, addTask, updateTask, exportTask } from "@/api/peri/task";
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除围手术期任务编号为"' + taskIds + '"的数据项?', "警告", {
