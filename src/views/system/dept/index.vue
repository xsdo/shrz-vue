    ...
    <el-dialog :title="title" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
         ...
         <!-- <el-col :span="12">
            <el-form-item label="民警人数" prop="mjrs">
              <el-input-number v-model="form.mjrs" controls-position="right" :min="0" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="辅警人数" prop="fjrs">
              <el-input-number v-model="form.fjrs" controls-position="right" :min="0" />
            </el-form-item>
          </el-col>-->
          <el-col :span="12">
