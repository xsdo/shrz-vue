<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
     ...
     <!-- <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['patient:user:remove']"
        >删除</el-button>
      </el-col>-->
     <!-- <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['patient:user:export']"
        >导出</el-button>
      </el-col>-->
      <el-col :span="1.5">
        <el-button
    ...
    <el-table style="width:100%" v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :show-overflow-tooltip="true" label="职业" align="center" prop="job" />
      <el-table-column :show-overflow-tooltip="true" label="诊断" align="center" prop="diagnosis" />
      <el-table-column label="学历" align="center" prop="education" />
      <el-table-column label="民族" align="center" prop="nation" />
      <el-table-column label="婚姻状况" align="center" prop="maritalStatus" :formatter="maritalStatusFormat" />
      <el-table-column label="出生日期" align="center" prop="birth" width="120"/>
...
<script>
  import { listUser, getUser, delUser, addUser, updateUser, exportUser,listNation,listPatientCategories,listSysHometown,delUserTask,updateDelFlag } from "@/api/patient/user";
    ...
    methods: {
     ...
     /* classificationCodingFormat(row, column) {
      ...
      handleUpdate(row) {
        ...
        getUser(patientId).then(response => {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除患者编号为"' + patientIds + '"的数据项?', "警告", {
          ...
          //return updateDelFlag(patientIds);
          return delUser(patientIds);
        }).then(() => {
          this.getList();
