      ...
      <el-table-column label="操作/任务状态" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-if="scope.row.taskStatus==null"
          >添加测评</el-button>
...
<script>
  ...
  import {listTask, getTask,addTask,delTask,updateTask,exportTask,getTaskByPatientId,updateByPatientId,getWorkstation} from "@/api/patient/intermediateTask";
